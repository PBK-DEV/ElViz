...
If you find a security vulnerability in elviz, please report it through [GitHub's private vulnerability reporting](https://github.com/PBK-DEV/ElViz/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact info@kochta.eu for details.
