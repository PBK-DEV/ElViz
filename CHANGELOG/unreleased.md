...
elviz started out as a project generated from [Cookiecutter PyPackage](https://github.com/audreyfeldroy/cookiecutter-pypackage) containing:

- Initial scaffold for elviz.
- `src/elviz/` package with CLI (Typer + Rich), py.typed marker
...
[@PBK-DEV](https://github.com/PBK-DEV) (Paul B. Kochta) created elviz.
